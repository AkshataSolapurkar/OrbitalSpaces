        ...
        <div className='bg-[#F9F4F4] h-[20px] relative'></div>
         <section className="max-w-[1200px] w-full text-[#2E5F53] m-auto px-[22px] py-0 mt-4 uppercase bg-white">
            ...
            <div className="max-w-[50%] flex flex-col mt-[100px] gap-[2%] text-left ">
                ...
                <button onClick={prop.logout} className="text-[16px] w-[40%] text-center font-semibold bg-[#2E5F53] mt-[50px] text-white py-[12px] px-[30px] rounded-[10px]">Get Started</button>
            </div>
